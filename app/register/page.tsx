  ...
  return (
   <div className='bg-black'>
     <div style={{ 
       ...
       className='h-dvh w-dvw'><div className='h-dvh bg-gradient bg-gradient-to-b from-black/80 via-black/40 to-black/100 flex flex-col justify-center items-center gap-12'>
        <Image src={logo} alt='yolo golden logo'/>
